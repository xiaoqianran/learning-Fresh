...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Fresh 实战学习 · 系统路径",
      },
      {
        name: "description",
        content:
          "Deno Fresh 中文交互教程：Islands、Handler、工坊闯关、文档地图与 Catppuccin 主题。",
      },
    ],
    links: [
